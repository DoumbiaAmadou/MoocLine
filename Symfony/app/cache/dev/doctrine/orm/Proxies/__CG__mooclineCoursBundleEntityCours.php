...
class Cours extends \moocline\CoursBundle\Entity\Cours implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'id', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'nom', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'categorie', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'enseignant', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'presentation', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'chapitres', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'etudiants', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'dateDebut', '' . "\0" . 'moocline\\CoursBundle\\Entity\\Cours' . "\0" . 'dateFin');
        }
